...
irrelevant_definition_path = '../data/relevant_irrelevant_llama-exactreplication.txt'
...
relevant_definition_path = '../data/relevant_irrelevant_2-exactreplication.txt'
