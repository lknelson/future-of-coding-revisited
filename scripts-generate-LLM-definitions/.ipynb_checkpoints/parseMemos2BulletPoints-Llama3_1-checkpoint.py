...
irrelevant_definition_path = '../data/relevant_irrelevant_llama3_1-exactreplication.txt'
...
relevant_definition_path = '../data/relevant_irrelevant_2-exactreplication-llama3_1.txt'
