...
output = ollama.chat(
    ...
    messages=[
        ...
        {
            "role": "user",
            "content": "Read the following document: " + memo_1[:8000*4]
        },
        {
            "role": "user",
            "content": prompt
...
irrelevant_definition_path = '../data/relevant_irrelevant_gemma-exactreplication.txt'
...
output_2 = ollama.chat(
    ...
    messages=[
        ...
        {
            "role": "user",
            "content": "Read the following document: " + memo_2[:8000*4]
        },
        {
            "role": "user",
            "content": prompt
...
relevant_definition_path = '../data/relevant_irrelevant_2-gemma-exactreplication.txt'
